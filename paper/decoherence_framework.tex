...
horizon scale~\cite[App.~B]{MISSING:dipole-appendix-ref} — the difference of
...
%% - Wald84    -- Wald, General Relativity (1984) [for conformal coupling R/6]
%% - MISSING:dipole-appendix-ref -- forward ref to App. B (dipole validity)
